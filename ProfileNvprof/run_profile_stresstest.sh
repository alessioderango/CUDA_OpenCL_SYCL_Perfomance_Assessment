...
OutputDir=./LogProfile_stresstest_gpu_$2_block_size_$4_hostname_${HOSTNAME}_`date +"%Y-%m-%d_%T"`
mkdir -p ${OutputDir}
...
executableStrCUDA=" ./sciddicaTcudaStraightforward ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_cuda 100 $4 $4 && cd .."
executableStrRuntimeCUDA=" ./sciddicaTcudaStraightforward ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_cuda 64000 $4 $4 && cd .."
