...
OutputDir=./LogProfile_stresstest_with_halo_gpu_$2_block_size_$4_hostname_${HOSTNAME}_`date +"%Y-%m-%d_%T"`
mkdir -p ${OutputDir}
...
executableStrCUDA=" ./sciddicaTcudawithHaloCells ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_cuda 100 $4 $4 && cd .."
executableStrRuntimeCUDA=" ./sciddicaTcudawithHaloCells ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_cuda 64000 $4 $4 && cd .."
...
executableStrSYCL=" ./sciddicaTsycl_dpcpp_with_halo_cells ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_OpenCL 100 $4 $4 && cd .."
executableStrRuntimeSYCL=" ./sciddicaTsycl_dpcpp_with_halo_cells ../data/tessina_headerX16.txt ../data/tessina_demX16.txt ../data/tessina_sourceX16.txt ./tessina_output_OpenCL 64000 $4 $4 && cd .."
