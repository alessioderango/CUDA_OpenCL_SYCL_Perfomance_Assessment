...
OutputDirRoot=./LogOuputStresstest_`date +"%Y-%m-%d_%T"`
...
declare -a TargetRunMake=(       run_straightforward16          run_straightforward16      run_straightforward_dpcpp16 )  
...
declare -a OutputDirLocal=(      ${OutputDirRoot}/CUDA_Tiled_withhalocells   ${OutputDirRoot}/CUDA_Tiled_withouthalocells   ${OutputDirRoot}/OpenCL_without_halocells  ${OutputDirRoot}/OpenCL_with_halocells  ${OutputDirRoot}/SYCL_DPCCC_WITHOUT_HALO_CELL ${OutputDirRoot}/SYCL_DPCCC_WITH_HALO_CELLS )
...
declare -a TargetRunMakeLocal=(  run_withhalocells16                         run_withouthalocells16                         run_without_halo_cells16                   run_with_halo_cells16                   run_withhout_halo_cells_dpcpp16               run_with_halo_cells_dpcpp16                 )
    ...
    then
        ...
        do
            ...
            do
                ...
                #echo "Considero ${NameTest[$t]} ${SIZE_Y}_${SIZE_X}_${test} =$min"
        ...
        do
            ...
            do
                ...
                echo "Considero ${NameTest[$t]} ${SIZE_X}_${SIZE_Y}_${test} =$min"
                outputResultsGlobal[${count}]+=${min}
                ((count=count+1)) 
                unset timesResults
            done
